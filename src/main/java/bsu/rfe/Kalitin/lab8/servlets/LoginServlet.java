package bsu.rfe.Kalitin.lab8.servlets;
...
import bsu.rfe.Kalitin.lab8.entity.ChatUser;
public class LoginServlet extends ChatServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse
        ...
        pw.println("<html><head><title>Chat Server</title><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/></head>");
